...
namespace Avalonia.Labs.Notifications.Android
{
    internal class NativeNotification : INativeNotification
    {
        ...
        public NativeNotification(Context context, NativeNotificationManager manager, NotificationChannel channel)
        {
            _context = context;
            _manager = manager;
            _channel = channel;
        ...
        public void Show()
        {
            ...
            builder.SetDeleteIntent(PendingIntent.GetBroadcast(_context, pendingIntentId + 2, deleteIntent, flags));
